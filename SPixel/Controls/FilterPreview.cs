...
namespace SPixel
{
    public class FilterPreview : System.Windows.Forms.Control
    {
        ...
        public FilterPreview()
        {
            ...
            cursorHand = new Cursor(assembly.GetManifestResourceStream("SPixel.Resources.harrow.cur"));
            cursorHandMove = new Cursor(assembly.GetManifestResourceStream("SPixel.Resources.hmove.cur"));
        }
